(function() {
  ...
  public.task = function( storeTask, taskId, checkCompleted ) {
    this.taskId = taskId;
  ...
  ***************************/
  function Tab (config)
  {
    ...
    this.checkCompleted = config.checkCompleted;
  ...
  Tab.prototype.handleMouseup = function(self)
  {
    ...
    this.checkCompleted(this.id, this.match.storeTask, [this.covering.text, this.covering.id]);
  ...
  ***************************/
  ...
  public.task.prototype.getDims = function(obj)
  {
  ...
  public.task.prototype.componentsInit = function(self, $task)
  {
    this.tabs = this.slots.map( function( slot, i)
    {
      var a = self.answers[i],
          tab = new Tab({
            checkCompleted: self.checkCompleted,
