...
*************************************************************************************************************************/
  ...
  gotoScorepage = function()
  {
    ...
    asyncLoop(
      ...
      function() { initScorepage(); scoreNav(); }
    );
  },
...
// add in hotSpot popover
  ...
  initStore = function(buildOrder)
  {
    ...
    store.stats = {
      testTitle: store.randomJSON.testInfo,
      passRequirement: store.randomJSON.PassRequirement,
      numTasks: store.randomJSON.NoOfTasks,
      durationTime: store.randomJSON.DurationTime,
      alertTime: store.randomJSON.AlertTime,
      completedTasks: 0,
      totalCorrect: 0
    };
