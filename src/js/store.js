let store = {
  ...
  langData: null, //    JSON object containing array of translation terms
  updateLanguage: (langID, langBlock) =>
  {
    for (let term in store.langData[langID][langBlock])
    {
      $(term).text(store.langData[langID][langBlock][term]);
    }
  },
  templates : null // (object)
  //    'node' : jquery node object
};
